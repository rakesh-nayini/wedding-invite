...
export default function WhenWhere() {
  ...
  return (
    <section
      id="when"
      className="bg-[var(--beige)]/35 px-5 py-10 md:py-14"
    >
      ...
      <div className="mx-auto mt-4 w-full max-w-md space-y-3">
        {cards.map((v) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="glass group flex items-center gap-4 rounded-2xl px-4 py-3.5 transition active:scale-[0.98]"
          >
            ...
            <span className="text-[10px] uppercase tracking-[0.18em] text-maroon/40 group-hover:text-gold">Map</span>
          </a>
        ))}
      </div>
    </section>
